...
```sh
npm install git+ssh://git@github.com:Triglit/typescript-sdk.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/Triglit/typescript-sdk/issues) with questions, bugs, or suggestions.
