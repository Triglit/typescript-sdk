# Triglit TypeScript API Library

[![NPM version](<https://img.shields.io/npm/v/triglit.svg?label=npm%20(stable)>)](https://npmjs.org/package/triglit) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/triglit)

This library provides convenient access to the Triglit REST API from server-side TypeScript or JavaScript.

The REST API documentation can be found on [docs.triglit.com](https://docs.triglit.com). The full API of this library can be found in [api.md](api.md).
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/triglit-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install triglit`
...
1. Via the `TRIGLIT_LOG` environment variable
...
```ts
import Triglit from 'npm:triglit';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/triglit-typescript/issues) with questions, bugs, or suggestions.
